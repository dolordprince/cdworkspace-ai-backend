...
The new design uses custom CSS variables defined in `../web-core/src/app/styles/new/index.css` and configured in `tailwind.config.cjs`. All styles are scoped to the `.new-design` class.

...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "diagonal-lines":
          "repeating-linear-gradient(-45deg, hsl(var(--text-low) / 0.4) 0 2px, transparent 1px 12px), linear-gradient(hsl(var(--bg-primary)), hsl(var(--bg-primary)))",
      },
